import{r as j,j as e}from"./react-vendor-n1G6Tmhm.js";import{u as F}from"./index-ykir6fhH.js";import{T as O,a as R,D as G,b as z,g as B}from"./teacherTools-DqzVduFS.js";import{d as W}from"./lessonPlanToDocx-38swv5ji.js";import{u as I}from"./useFormDefaultsFromUrl-hyQF78O6.js";import"./router-vendor-m0NUYPg4.js";import"./vendor-DXGGfMZf.js";import"./firebase-vendor-CMGKOjez.js";import"./sanitize-vendor-DKgZpLtg.js";import"./icons-vendor-CY4OHkc8.js";const C="#059669";function U(t,i="CBC Lesson Plan"){if(!t)throw new Error("No lesson plan to export.");const s=window.open("","_blank","noopener,noreferrer,width=900,height=1100");if(!s)throw new Error("Your browser blocked the print window. Please allow pop-ups and try again.");const n=_(t,i);s.document.open(),s.document.write(n),s.document.close();const r=()=>{try{s.focus(),s.print()}catch{}};s.document.readyState==="complete"?setTimeout(r,120):s.addEventListener("load",()=>setTimeout(r,120))}function _(t,i){var m,b,f,y,x,N,v,p,d,w;const s=t.header||{},n=a=>a==null?"":H(String(a)),r=[["School",s.school],["Teacher",s.teacherName],["Date",s.date],["Time",s.time],["Duration",s.durationMinutes?`${s.durationMinutes} min`:""],["Class",s.class],["Subject",s.subject],["Topic",s.topic],["Sub-topic",s.subtopic],["Term & Week",s.termAndWeek],["Number of Pupils",s.numberOfPupils],["Medium",s.mediumOfInstruction]].filter(([,a])=>a!=null&&a!==""),l=a=>(a||[]).length?`<ul>${(a||[]).map(h=>`<li>${n(h)}</li>`).join("")}</ul>`:'<p class="muted">—</p>',S=a=>(a||[]).length?`<ol>${(a||[]).map(h=>`<li>${n(h)}</li>`).join("")}</ol>`:'<p class="muted">—</p>',u=(a,h)=>h?`
      <div class="phase">
